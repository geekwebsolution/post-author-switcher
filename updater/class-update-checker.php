<?php
if (!class_exists('GCLPAS_Update_Checker')) {

    class GCLPAS_Update_Checker {
        ...
        public function __construct() {
            $utility = gclpas_updater_utility();
        ...
        public function check_for_updates($transient) {
            ...
            $transient_name = 'gclpas_plugin_updates';
